    ...
    <svg style={{ position: 'absolute', width: 0, height: 0, overflow: 'hidden' }} version="1.1" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <symbol id="icon-building" viewBox="0 0 32 32">
          ...
          <path d="M6 2h20v28h-7v-6h-6v6h-7v-28zM10 6v3h3v-3h-3zM19 6v3h3v-3h-3zM10 12v3h3v-3h-3zM19 12v3h3v-3h-3zM10 18v3h3v-3h-3zM19 18v3h3v-3h-3z" />
        </symbol>
        ...
        {/* <!-- Vizzuality components icons, only the ones used in the project instead of loading all of them --> */}
