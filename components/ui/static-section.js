...
const StaticSection = ({ children, background, backgroundProps, column, className, position, map }) => {
  const setPosition = () => {
    return classnames({
      '-top': position.top,
  ...
  return (
    ...
    >
      ...
      <div className={`c-static-box ${setPosition()}`}>
        <div className="l-container">
          <div className={`row collapse ${setJustify()}`}>
