...
const MAP_LAYERS_OPERATORS_DETAIL = [
...

  {
    ...
    source: {
      type: 'geojson',
      data: {
        url: `${process.env.OTP_API}/fmus?country_ids=7,47,45,188,53&operator_ids={{OPERATOR_ID}}&format=geojson`,
        method: 'GET',
        headers: {
  ...
  },
  {
    ...
    source: {
      type: 'geojson',
      data: {
        url: `${process.env.OTP_API}/sawmills?country_ids=7,47,45,188,53&operator_ids={{OPERATOR_ID}}&format=geojson`,
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'OTP-API-KEY': process.env.OTP_API_KEY
